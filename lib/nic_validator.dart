...
class Validators {
  ...
  static RegExp nicValidPattern() {
    RegExp regex = RegExp(
        r'^(?=((?:19|20)?\d{2}(?:[0-35-8]\d\d(?!(?:000|500|36[7-9]|[7-9]\d|86[7-9]|8[7-9]\d)))\d{5})).*$|^(1[0-9]|[2-9][0-9])(?:[0-35-8]\d\d(?!(?:000|500|36[7-9]|[7-9]\d|86[7-9]|8[7-9]\d)))(.{4}[vVxX])$');
    return regex;
  }
}
